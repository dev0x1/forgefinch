...
description: Use for C4-style context, container, component, and code-level diagrams inside a workpackage or slice.
---
...
Support C4-style context, container, component, and code-level diagrams inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches C4-style context, container, component, and code-level diagrams.
