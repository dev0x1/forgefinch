...
description: Use for misuse cases for product, platform, data, and integration changes inside a workpackage or slice.
---
...
Support misuse cases for product, platform, data, and integration changes inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches misuse cases for product, platform, data, and integration changes.
