---
name: tdd-loop
description: Use for test-first implementation for domain, application, adapter, policy, and integration work inside a workpackage or slice.
---
...
Support test-first implementation for domain, application, adapter, policy, and integration work inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches test-first implementation for domain, application, adapter, policy, and integration work.
