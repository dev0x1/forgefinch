---
name: service-graphiti-integration
description: Use for Graphiti temporal knowledge graphs, entity extraction, and memory candidates inside a workpackage or slice.
---

# service-graphiti-integration

## Purpose

Support Graphiti temporal knowledge graphs, entity extraction, and memory candidates inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches Graphiti temporal knowledge graphs, entity extraction, and memory candidates.
