...
description: Use for memory registry, memory candidates, lineage, scope, retention, and Graphiti integration inside a workpackage or slice.
---
...
Support memory registry, memory candidates, lineage, scope, retention, and Graphiti integration inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches memory registry, memory candidates, lineage, scope, retention, and Graphiti integration.
