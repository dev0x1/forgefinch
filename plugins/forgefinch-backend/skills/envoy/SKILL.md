---
name: envoy
description: Use for Envoy edge proxy config, routes, local access logs, and authz integration inside a workpackage or slice.
---
...
Support Envoy edge proxy config, routes, local access logs, and authz integration inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches Envoy edge proxy config, routes, local access logs, and authz integration.
