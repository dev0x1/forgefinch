---
name: service-airweave-integration
description: Use for Airweave collections, source connections, sync jobs, search APIs, and ACL metadata inside a workpackage or slice.
---

# service-airweave-integration

## Purpose

Support Airweave collections, source connections, sync jobs, search APIs, and ACL metadata inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches Airweave collections, source connections, sync jobs, search APIs, and ACL metadata.
