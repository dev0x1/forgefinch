---
name: ports-adapters-boundary
description: Use for ports-and-adapters boundaries for services, frameworks, providers, and substrates inside a workpackage or slice.
---
...
Support ports-and-adapters boundaries for services, frameworks, providers, and substrates inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches ports-and-adapters boundaries for services, frameworks, providers, and substrates.
