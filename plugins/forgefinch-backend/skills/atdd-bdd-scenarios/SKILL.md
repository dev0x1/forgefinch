---
name: atdd-bdd-scenarios
description: Use for behavior scenarios for user-visible or workflow behavior inside a workpackage or slice.
---
...
Support behavior scenarios for user-visible or workflow behavior inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches behavior scenarios for user-visible or workflow behavior.
