...
description: Use for policy simulations for OPA, OpenFGA, Cedar, and Regorus decisions inside a workpackage or slice.
---
...
Support policy simulations for OPA, OpenFGA, Cedar, and Regorus decisions inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches policy simulations for OPA, OpenFGA, Cedar, and Regorus decisions.
