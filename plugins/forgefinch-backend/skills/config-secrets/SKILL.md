---
name: config-secrets
description: Use for typed configuration, env files, secret refs, redaction, and feature toggles inside a workpackage or slice.
---
...
Support typed configuration, env files, secret refs, redaction, and feature toggles inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches typed configuration, env files, secret refs, redaction, and feature toggles.
