...
description: Use for service health, startup, dependency, and shutdown behavior inside a workpackage or slice.
---
...
Support service health, startup, dependency, and shutdown behavior inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches service health, startup, dependency, and shutdown behavior.
