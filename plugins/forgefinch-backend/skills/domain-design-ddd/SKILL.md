---
name: domain-design-ddd
description: Use for domain models, entities, value objects, events, commands, and invariants inside a workpackage or slice.
---
...
Support domain models, entities, value objects, events, commands, and invariants inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches domain models, entities, value objects, events, commands, and invariants.
