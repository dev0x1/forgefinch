---
name: runbooks
description: Use for local runbooks for startup, reset, failure modes, and service operation inside a workpackage or slice.
---
...
Support local runbooks for startup, reset, failure modes, and service operation inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches local runbooks for startup, reset, failure modes, and service operation.
