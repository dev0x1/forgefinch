---
name: service-restate-integration
description: Use for Restate service deployment, handlers, durable adapters, retries, and idempotency inside a workpackage or slice.
---

# service-restate-integration

## Purpose

Support Restate service deployment, handlers, durable adapters, retries, and idempotency inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches Restate service deployment, handlers, durable adapters, retries, and idempotency.
