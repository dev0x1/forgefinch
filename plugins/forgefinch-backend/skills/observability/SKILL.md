---
name: observability
description: Use for tracing, metrics, logs, collectors, dashboards, and telemetry code inside a workpackage or slice.
---
...
Support tracing, metrics, logs, collectors, dashboards, and telemetry code inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches tracing, metrics, logs, collectors, dashboards, and telemetry code.
