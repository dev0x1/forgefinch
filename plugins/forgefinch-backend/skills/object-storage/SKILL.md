---
name: object-storage
description: Use for object storage, evidence artifacts, object metadata, and presigned access inside a workpackage or slice.
---
...
Support object storage, evidence artifacts, object metadata, and presigned access inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches object storage, evidence artifacts, object metadata, and presigned access.
