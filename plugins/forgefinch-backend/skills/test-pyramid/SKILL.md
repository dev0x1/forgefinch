---
name: test-pyramid
description: Use for balanced tests across unit, property, integration, contract, golden trace, policy, and eval checks inside a workpackage or slice.
---
...
Support balanced tests across unit, property, integration, contract, golden trace, policy, and eval checks inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches balanced tests across unit, property, integration, contract, golden trace, policy, and eval checks.
