---
name: durable-restate
description: Use for durable execution boundaries, waits, retries, cancellations, and Restate adapters inside a workpackage or slice.
---
...
Support durable execution boundaries, waits, retries, cancellations, and Restate adapters inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches durable execution boundaries, waits, retries, cancellations, and Restate adapters.
