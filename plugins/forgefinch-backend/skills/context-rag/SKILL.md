---
name: context-rag
description: Use for permission-aware retrieval, source sync, document ingestion, chunking, and search context inside a workpackage or slice.
---
...
Support permission-aware retrieval, source sync, document ingestion, chunking, and search context inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches permission-aware retrieval, source sync, document ingestion, chunking, and search context.
