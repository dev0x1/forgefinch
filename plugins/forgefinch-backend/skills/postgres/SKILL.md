---
name: postgres
description: Use for Postgres schemas, SQLx queries, tenant isolation, transactions, and outbox tables inside a workpackage or slice.
---
...
Support Postgres schemas, SQLx queries, tenant isolation, transactions, and outbox tables inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches Postgres schemas, SQLx queries, tenant isolation, transactions, and outbox tables.
