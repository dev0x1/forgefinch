...
description: Use for cross-tenant negative tests for data, prompts, retrieval, memory, evidence, and logs inside a workpackage or slice.
---
...
Support cross-tenant negative tests for data, prompts, retrieval, memory, evidence, and logs inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches cross-tenant negative tests for data, prompts, retrieval, memory, evidence, and logs.
