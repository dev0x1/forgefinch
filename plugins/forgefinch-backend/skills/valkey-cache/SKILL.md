---
name: valkey-cache
description: Use for Valkey cache, rate limits, sessions, subscriptions, and local locks inside a workpackage or slice.
---
...
Support Valkey cache, rate limits, sessions, subscriptions, and local locks inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches Valkey cache, rate limits, sessions, subscriptions, and local locks.
