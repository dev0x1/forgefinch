---
name: pr-review
description: Use for pull-request review for correctness, boundaries, security, tests, and local checks inside a workpackage or slice.
---
...
Support pull-request review for correctness, boundaries, security, tests, and local checks inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches pull-request review for correctness, boundaries, security, tests, and local checks.
