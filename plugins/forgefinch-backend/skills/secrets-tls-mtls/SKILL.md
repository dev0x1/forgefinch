---
name: secrets-tls-mtls
description: Use for service credentials, TLS/mTLS experiments, local root CA handling, and redaction inside a workpackage or slice.
---
...
Support service credentials, TLS/mTLS experiments, local root CA handling, and redaction inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches service credentials, TLS/mTLS experiments, local root CA handling, and redaction.
