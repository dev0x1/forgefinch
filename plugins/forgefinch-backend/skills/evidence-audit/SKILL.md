---
name: evidence-audit
description: Use for evidence packets, audit events, action ledger records, artifact refs, and replay support inside a workpackage or slice.
---
...
Support evidence packets, audit events, action ledger records, artifact refs, and replay support inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches evidence packets, audit events, action ledger records, artifact refs, and replay support.
