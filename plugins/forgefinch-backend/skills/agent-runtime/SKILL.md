---
name: agent-runtime
description: Use for agent runtime behavior, planners, reviewers, workers, and structured action proposals inside a workpackage or slice.
---
...
Support agent runtime behavior, planners, reviewers, workers, and structured action proposals inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches agent runtime behavior, planners, reviewers, workers, and structured action proposals.
