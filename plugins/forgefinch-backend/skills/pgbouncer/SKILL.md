---
name: pgbouncer
description: Use for PgBouncer pooling, pool sizing, transaction behavior, and local checks inside a workpackage or slice.
---
...
Support PgBouncer pooling, pool sizing, transaction behavior, and local checks inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches PgBouncer pooling, pool sizing, transaction behavior, and local checks.
