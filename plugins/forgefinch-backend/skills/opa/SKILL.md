---
name: opa
description: Use for OPA policies, bundles, decision logs, service config, and policy tests inside a workpackage or slice.
---
...
Support OPA policies, bundles, decision logs, service config, and policy tests inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches OPA policies, bundles, decision logs, service config, and policy tests.
