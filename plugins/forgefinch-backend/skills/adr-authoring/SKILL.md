---
name: adr-authoring
description: Use for architecture decisions in docs/architecture and affected architecture notes inside a workpackage or slice.
---
...
Support architecture decisions in docs/architecture and affected architecture notes inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches architecture decisions in docs/architecture and affected architecture notes.
