---
name: tool-gateway
description: Use for governed tools, connector actions, MCP adapters, idempotency, action ledger, and approvals inside a workpackage or slice.
---
...
Support governed tools, connector actions, MCP adapters, idempotency, action ledger, and approvals inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches governed tools, connector actions, MCP adapters, idempotency, action ledger, and approvals.
