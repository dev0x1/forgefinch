---
name: openfga
description: Use for OpenFGA authorization models, tuples, checks, and relationship tests inside a workpackage or slice.
---
...
Support OpenFGA authorization models, tuples, checks, and relationship tests inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches OpenFGA authorization models, tuples, checks, and relationship tests.
