---
name: evals-dev
description: Design and run local evals and golden traces for agentic behavior in a workpackage.
---
...
Support local evals, golden traces, structured outputs, and agentic regression cases inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches local evals, golden traces, structured outputs, and agentic regression cases.
