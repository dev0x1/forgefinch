---
name: vault
description: Use for Vault integration, secret resolution, policies, audit devices, and redaction behavior inside a workpackage or slice.
---
...
Support Vault integration, secret resolution, policies, audit devices, and redaction behavior inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches Vault integration, secret resolution, policies, audit devices, and redaction behavior.
