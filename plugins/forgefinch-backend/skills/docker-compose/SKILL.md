---
name: docker-compose
description: Use for Docker Compose profiles, local service wiring, images, volumes, and health checks inside a workpackage or slice.
---
...
Support Docker Compose profiles, local service wiring, images, volumes, and health checks inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches Docker Compose profiles, local service wiring, images, volumes, and health checks.
