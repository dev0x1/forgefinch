...
description: Use for local email testing, notification templates, approval emails, and digests inside a workpackage or slice.
---
...
Support local email testing, notification templates, approval emails, and digests inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches local email testing, notification templates, approval emails, and digests.
