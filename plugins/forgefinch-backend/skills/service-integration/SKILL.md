...
description: Use for external platform services, adapters, typed config, tests, telemetry, and runbooks inside a workpackage or slice.
---
...
Support external platform services, adapters, typed config, tests, telemetry, and runbooks inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches external platform services, adapters, typed config, tests, telemetry, and runbooks.
