...
description: Use for Prometheus scrape config, metrics, Grafana provisioning, and dashboards inside a workpackage or slice.
---
...
Support Prometheus scrape config, metrics, Grafana provisioning, and dashboards inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches Prometheus scrape config, metrics, Grafana provisioning, and dashboards.
