---
name: secure-dev
description: Review dev-phase security concerns for secrets, policy, tenant isolation, and guarded actions.
---
...
Support dev-phase security, secrets, policy checks, tenant isolation, and guarded actions inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches dev-phase security, secrets, policy checks, tenant isolation, and guarded actions.
