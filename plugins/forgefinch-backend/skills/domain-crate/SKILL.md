---
name: domain-crate
description: Use for bounded-context domain crates, application ports, infrastructure adapters, and tests inside a workpackage or slice.
---
...
Support bounded-context domain crates, application ports, infrastructure adapters, and tests inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches bounded-context domain crates, application ports, infrastructure adapters, and tests.
