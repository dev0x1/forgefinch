---
name: model-router
description: Use for Rig-backed model routing, provider fallback, prompts, budgets, and evidence links inside a workpackage or slice.
---
...
Support Rig-backed model routing, provider fallback, prompts, budgets, and evidence links inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches Rig-backed model routing, provider fallback, prompts, budgets, and evidence links.
