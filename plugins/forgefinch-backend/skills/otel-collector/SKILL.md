---
name: otel-collector
description: Use for OpenTelemetry Collector receivers, processors, exporters, and pipelines inside a workpackage or slice.
---
...
Support OpenTelemetry Collector receivers, processors, exporters, and pipelines inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches OpenTelemetry Collector receivers, processors, exporters, and pipelines.
