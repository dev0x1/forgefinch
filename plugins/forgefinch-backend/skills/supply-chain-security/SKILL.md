...
description: Use for dependency, license, SBOM, container image, and toolchain checks inside a workpackage or slice.
---
...
Support dependency, license, SBOM, container image, and toolchain checks inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches dependency, license, SBOM, container image, and toolchain checks.
