...
description: Use for authorization, policy, tenant isolation, intent checks, and AI guardrails inside a workpackage or slice.
---
...
Support authorization, policy, tenant isolation, intent checks, and AI guardrails inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches authorization, policy, tenant isolation, intent checks, and AI guardrails.
