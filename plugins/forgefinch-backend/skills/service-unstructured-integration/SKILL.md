---
name: service-unstructured-integration
description: Use for Unstructured document parsing, partitioning, chunking, and ingestion workers inside a workpackage or slice.
---

# service-unstructured-integration

## Purpose

Support Unstructured document parsing, partitioning, chunking, and ingestion workers inside the active workpackage.

## Use This Skill When

- The current workpackage or slice touches Unstructured document parsing, partitioning, chunking, and ingestion workers.
